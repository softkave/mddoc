...
import type {MddocJsConfigBase} from './config.js';
import {MddocJsConfig, MddocJsConfigAuthToken} from './config.js';
import {InvokeEndpointParams, invokeEndpoint} from './invokeEndpoint.js';
import type {MddocEndpointParamsOptional} from './types.js';
...
export class MddocEndpointsBase<
  TConfig extends MddocJsConfigBase = MddocJsConfigBase
> extends MddocJsConfig<TConfig> {
  protected getAuthToken(params?: {authToken?: MddocJsConfigAuthToken}) {
  ...
  protected async executeRaw(
    ...
    p02?: Pick<MddocEndpointParamsOptional<any>, 'authToken' | 'serverURL'> &
