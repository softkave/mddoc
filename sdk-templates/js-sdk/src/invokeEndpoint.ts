...
export async function invokeEndpoint(props: InvokeEndpointParams) {
  ...
  try {
    ...
    let errors: MddocEndpointErrorItem[] = [];
    let statusCode: number | undefined = undefined;
    let statusText: string | undefined = undefined;
    let responseHeaders: MddocEndpointHeaders | undefined = undefined;
    ...
    if ((axiosError as any).response) {
      ...
      responseHeaders = response.headers as MddocEndpointHeaders;
